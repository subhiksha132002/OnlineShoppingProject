...
try{
	...
	PreparedStatement ps1=conn.prepareStatement("UPDATE CART SET address=?,city=?,state=?,country=?,mobilenumber=?,orderDate = CURRENT_DATE,DELIVERYDATE = CURRENT_DATE + INTERVAL '7 DAYS',paymentMethod=?,transactionId=?,status=? where email=? and address is NULL");
